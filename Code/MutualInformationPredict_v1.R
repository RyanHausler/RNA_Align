...
ls <- list.files("~/Desktop/Alignment/RNABenchmarks/Rfam_Seeds/seed/") # use all files
...
rna <- readRNAStringSet(paste0("~/Desktop/Alignment/RNABenchmarks/Rfam_Seeds/seed/", ls[k]))
